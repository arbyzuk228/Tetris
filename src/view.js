export default class View {
    ...
    renderStartScreen() {
        ...
        this.context.fillText('Press Space for', this.width / 2, this.height / 2 + 30);
        this.context.fillText('check result table', this.width / 2, this.height / 2 + 60);
    }
    ...
    renderPauseScreen() {
        ...
        this.context.textAlign = 'center';
        this.context.textBaseline = 'middle';
        this.context.fillText('PAUSE', this.width / 2, this.height / 2 - 24);
        this.context.fillText('Press ENTER to Resume', this.width / 2, this.height / 2);
    }

    renderEndScreen({ name, score }) {
        this._clearScreen();
        ...
        this.context.textAlign = 'center';
        this.context.textBaseline = 'middle';
        this.context.fillText('GAME OVER', this.width / 2, this.height / 2 - 64);
        this.context.fillText(`Name: ${name}`, this.width / 2, this.height / 2 - 24);
        this.context.fillText(`Score: ${score}`, this.width / 2, this.height / 2 + 6);
